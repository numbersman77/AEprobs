...
* `data_generation_constant_cens`: This function generates the dataset denoted by $S1$ in Table~4 of @stegherr_20_sap, i.e. we assume constant hazards for the AE hazard, the hazard for the competing event of death, and the hazard for the "soft" competing events. Censoring is uniform.
